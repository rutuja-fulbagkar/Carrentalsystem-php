...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT c.car_name,d.driver_name, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type, rc.id ,rc.no_of_days FROM 
    rentedcars rc, cars c,driver d
    WHERE rc.customer_username='$login_customer' AND c.car_id=rc.car_id AND rc.driver_id=d.driver_id AND rc.return_status='NR'";
    $result1 = $conn->query($sql1);

    if (mysqli_num_rows($result1) > 0) {

    // $sql1 = "SELECT * FROM rentedcars  rc ,cars c where rc.car_id=c.car_id";
    // $result1=$conn->query($sql1);
