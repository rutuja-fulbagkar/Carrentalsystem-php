...
body {
  ...
  background-size: 100% 100%;
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation"  style="background-color:#527a7a">
            ...
            ?>
                        ...
                        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li>
                                    <a href="clientlogin.php"><b>Employee</b></a>
                                </li>
                                <li>
                                    <a href="customerlogin.php"><b>Customer</b></a>
                                </li>
                                <li>
                                    <a href="faq/index.php"> <b>FAQ</b> </a>
                                </li>
                            </ul>
                        </div>
                        <?php   }
        ...
        <div class="container">
            <div class="jumbotron"  style="  background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%);">

            <h3 class="text-center"><b>Car Rentals - Customer Panel</b> </span>
                </h1>
                <br>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <label style="margin-left: 5px;"><a href="customersignup.php"><b>Create a new account.</b></a></label>
                        </form>
                    </div>
                </div>
            </div>
