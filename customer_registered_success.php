...
<div class="container">
	<div class="jumbotron" style="background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%); text-align: center;">
		<h2> <?php echo "Welcome $customer_name!" ?> </h2>
		<h1>Your account has been created.</h1>
		<p>Login Now from <a href="customerlogin.php"><b>HERE</b></a></p>
	</div>
</div>
