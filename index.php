...
<head>
    ...
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700,400italic,700italic"
...
"   
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="clientlogin.php"><b>Admin</b></a>
                    </li>
                    <li>
    ...
    <div id="sec2" style="color: #777;background-color;text-align:center;padding:50px 80px;
 background: linear-gradient(to top left, #ccccff 0%, #ffffff 100%);    text-align: justify;">
