...
body {
 ...
 <!-- Navigation -->
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color:#33475b" style="color: black">
        <div class="container">
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> <b>Enter Driver Details</b> </h3>
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"><b> My Drivers</b> </h3>
<?php
// Storing Session
...
<footer class="site-footer">
        <div class="">
            <hr>
            <div class="row">
                <div class="col-sm-12" style="background-color:#33475b">
