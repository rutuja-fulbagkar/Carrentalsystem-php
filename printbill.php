...
<!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" style="background-color:#527a7a"  role="navigation"
     style="color: white">
        <div class="container">
...
?>
    ...
    <div class="container">
        ...
        <h2><input type="submit" class="btn btn-primary" onclick="window.print()" value="Print Here" /></h2>
					  
        <h6>Warning! <strong>Do not reload this page</strong> 
        or the above display will be lost. If you want a hardcopy of this page, please print it now.</h6>
        </div>
    </div>
