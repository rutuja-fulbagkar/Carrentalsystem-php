...
body {
  ...
  opacity: ;
      ...
      <!-- Navigation -->
     <!-- Navigation -->
     <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color:#527a7a
"   
     style="color: white">
        <div class="container">
...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
         ...
         <h5> Charge type:  &nbsp;
            ...
            <br><br>
                ...
                <select name="driver_id_from_dropdown" ng-model="myVar1">
                        ...
                        --  AND d.client_username IN (SELECT cc.client_username FROM clientcars cc WHERE
                        --   cc.car_id = '$car_id')";
                    ...
                    Sorry! No Drivers are currently available,you can  try again later...
                        <?php
                    }
                    ?>
                </select>
      ...
      <div class="col-md-12" style="float: none; padding: 0px; background-color:white">
            <h4><strong>Note:</strong> You will be charged with extra <span class="text-danger">Rs. 500</span> for each day after the due date ends.</h4>
        </div>
    </div>
...
<footer class="site-footer">
        <div class="">
            <hr>
            <div class="row">
                <div class="col-sm-12" style="background-color:#527a7a">
